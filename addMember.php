...
if (isset($_POST['daftar'])) {
    ...
    $sql = "INSERT INTO `sysdb_member` (`id_member`, `name`, `username`, `email`, `password`, `theme`) VALUES ('$id', '$fullname', '$username', '$email', '$password', 'dheafault')";
    $sql_addTable = "CREATE TABLE `sysdb-$username` ( `id` int(5) NOT NULL AUTO_INCREMENT, `name-link` varchar(20) DEFAULT NULL, `url-link` text NOT NULL, `deskripsi-link` text NOT NULL, `view-link` varchar(20) NOT NULL, `stat-link` int(10) NOT NULL, `sort` int(10) NOT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=latin1";
